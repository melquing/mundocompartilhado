let dados = [
    ...
    {
        titulo: "Malta: Uma joia do Mediterrâneo.",
        ...
        link: "https://pt.wikipedia.org/wiki/Malta",
        i1: "IMG_maltablf.JPEG",
        i2: "IMG_maltacity.JPEG",
        i3: "IMG_maltabls.JPEG",
        
    },

    {
    titulo: "Italia: Diversidade e história",
    ...
    {
    titulo: "Espanha: Latinos na Europa",
    experiencia: "Barcelona tem muitos pontos turisticos, porem estavamos proximo a La Rambla, é um calçadao cheio de lojas e restaurantes, muita cultura, diversidade, a culinaria local é bem rica, se voce vai a Barcelona precisa comer uma Paeja, a Mayara não come peixe então tive que me deliciar sozinho.A La Rambla é um lugar vibrante e cheio de vida. As lojas de souvenirs, os artistas de rua e os restaurantes com terraços convidativos criam um ambiente único. Uma das minhas partes favoritas foi assistir aos artistas de rua, como os mímicos e os músicos, que interagiam com os turistas. Valência, uma cidade vibrante na costa leste da Espanha, oferece um rico mix de cultura, história e arquitetura. Suas ruas estreitas e coloridas te transportam para o passado, enquanto seus edifícios modernos e inovadores te conectam com o futuro. A cidade possui um centro histórico encantador, com edifícios góticos, renascentistas e barrocos, como a Lonja de la Seda, um Patrimônio Mundial da UNESCO.",
    ...
    {
        titulo: "Chile no inverno: Aventura na Neve",
       ...
       {
        titulo: "Marrocos: Maior choque cultural.",
        experiencia: "Nossa visita ao Marrocos foi rápida, mas valeu muito a experiência. Uma das coisasque me surpreendeu muito foi o idioma, achei que seria uma barreira, pois não falo francês e muito menos árabe. Mas os marroquinos tem uma grande predisposição para aprender idiomas, faziam o que podiam para se comunicar, alguns até arranhando o português, citando times e jogadores de futebol do Brasil. Além de mesquitas maravilhosas, você pode comer comidas ótimas. Prove a culinária local, você não vai se arrepender. Em Marrocos, o consumo de bebidas alcoólicas é proibido, então terá que procurar bem se quiser provar uma cerveja marroquina.",
        link: "https://pt.wikipedia.org/wiki/Marrocos",
        i1: "IMG_marrocos1.jpg",
        i2: "IMG_marrocos2.jpg",
        i3: "IMG_marrocos3.jpg",
    },
        {
             
                titulo: "Tunisia, agito e calor",
                experiencia: "A Tunísia é um país fascinante, onde a história se entrelaça com a modernidade,  os tunisianos tem uma boa hospitalidade, apesar de ser uma pais dificil em comunicação pra quem não fala Frances ou Arabe, A dança também ocupa um lugar importante nessa viagem, ja que em todos os lugares se pode ver ou escutar a tipica musica deles, muitas coisas feitas em ceramica e claro os classicos tapetes, segundo um amigo que é Tunisiano, a Tunisia é um dos países árabes mais liberais em relaçao aos direitos da mulher. Tivemos uma otima experiencia com a comida local e o famoso por sírio.",
                link: "https://pt.wikipedia.org/wiki/Tun%C3%ADsia",
                i1: "IMG_tunis1.jpg",
                i2: "IMG_tunis2.jpg",
                i3: "IMG_tunis3.jpg",
        },
